...
export default {
  ...
  methods: {
    getCoordinates: function () {
      axios
        .get(
          "https://api.mapbox.com/datasets/v1/wormmt/cks55annx0tdr22tgwixdcv81/features?access_token=sk.eyJ1Ijoid29ybW10IiwiYSI6ImNrczVlcWs2cDFoeHgybm80NXo1NmZwY3AifQ.OITJ9BiOr6wA9Hi0TJ4qUQ"
        )
        .then((response) => {
          ...
          for (let i = 0; i < features.length; i++) {
            ...
            this.imageurl.push(
              `https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/${features[i].geometry.coordinates},15/300x200?access_token=pk.eyJ1Ijoid29ybW10IiwiYSI6ImNrczg1NWV4djJ4Y2sydnFtcDgyNXlkdmMifQ._rDK4Ue_fL-uOtpBPIczww`
            );
          }
        });
    },
